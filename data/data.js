export const learningPaths = [
  {
    ...
    content: {
      es: "La ruta de aprendizaje de Frontend te sumerge en el fascinante mundo de la creación visual y funcional de interfaces web. Desde los fundamentos del desarrollo web con HTML, CSS y JavaScript, avanzarás hacia frameworks modernos como React, Angular o Vue.js. Aprenderás a optimizar la experiencia del usuario, trabajar con AJAX para cargar datos dinámicamente y dominarás conceptos cruciales como responsive design y accesibilidad. Además, explorarás herramientas de construcción y gestión de dependencias, como npm y webpack. La integración de API y la comprensión de conceptos como el Modelo de Documento del Objeto (DOM) serán clave para potenciar tus habilidades en el desarrollo Frontend y crear experiencias web excepcionales.",
      en: "The Frontend learning path immerses you in the fascinating world of visual and functional web interface creation. Starting from the basics of web development with HTML, CSS, and JavaScript, you'll progress towards modern frameworks such as React, Angular, or Vue.js. You'll learn to optimize user experience, work with AJAX for dynamic data loading, and master crucial concepts like responsive design and accessibility. Additionally, you'll explore build and dependency management tools like npm and webpack. API integration and understanding concepts such as the Document Object Model (DOM) will be key to enhancing your Frontend development skills and creating exceptional web experiences.",
    },
    thumbnail: "react",
    courses: [1, 2, 3, 4, 5],
  },
